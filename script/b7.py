...
if __name__ == "__main__":
    # Load config
    with open("config/b7.yml", "r") as f:
        cfg = yaml.safe_load(f)

    set_seed(cfg['hyperparameters']['seed'])

    logger = get_logger(exp_name="Baseline7", log_name="B7", logs_dir="logs")
...
model = Baseline7(input_size=cfg['hyperparameters']['input_size'], 
...
checkpoint = torch.load(r"checkpoints\baseline_7.pth", map_location="cpu")
