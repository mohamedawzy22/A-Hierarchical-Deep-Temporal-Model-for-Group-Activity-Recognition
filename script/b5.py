...
if __name__ == "__main__":
    # Load config
    with open(r"config\B5.yml", "r") as f:
        cfg = yaml.safe_load(f)

    set_seed(cfg['hyperparameters']['seed'])

    logger = get_logger(exp_name="Baseline5", log_name="B5", logs_dir="logs")
...
model = Baseline5(input_size=cfg['hyperparameters']['input_size'], 
...
checkpoint = torch.load(r"checkpoints\baseline_5.pth", map_location="cpu")
